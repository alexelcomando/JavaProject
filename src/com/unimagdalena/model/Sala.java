...
public class Sala {
    ...
    public Sala(int idSala, String nombreSala, Pelicula idPeliculaSala, Boolean estaDisponibleSala, int numeroAsientosSala, Boolean servicioVipSala, String nombreImagenPublicoSala, String nombreImagenPrivadoSala) {
        this.idSala = idSala;
    ...
    public Pelicula getIdPeliculaSala() {
    ...
    public Boolean getEstaDisponibleSala() {
        return estaDisponibleSala;
    }
    ...
    public int getNumeroAsientosSala() {
        return numeroAsientosSala;
    }
    ...
    public Boolean getServicioVipSala() {
        return servicioVipSala;
    }
