...
public class GeneroDto {
    ...
    public GeneroDto(int idGenero, String nombreGenero, Boolean estadoGenero, int cantPeliculasGenero, int calificacionGenero, LocalDate fechaCreacionGenero, String publicoObjetivoGenero, String nombreImagenPublicoGenero, String nombreImagenPrivadoGenero) {
