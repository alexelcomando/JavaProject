...
public class EmpleadoDto {
    ...
    private SalaDto salaAsignadaEmpleado;
    ...
    public EmpleadoDto(int idEmpleado, String nombreEmpleado, Boolean esTiempoCompletoEmpleado, String nivelAccesoEmpleado, SalaDto salaAsignadaEmpleado, LocalTime horaEntradaEmpleado, LocalTime horaSalidaEmpleado, String nombreImagenPublicoEmpleado, String nombreImagenPrivadoEmpleado) {
    ...
    public SalaDto getSalaAsignadaEmpleado() {
        return salaAsignadaEmpleado;
    }

    public void setSalaAsignadaEmpleado(SalaDto salaAsignadaEmpleado) {
        this.salaAsignadaEmpleado = salaAsignadaEmpleado;
    }
