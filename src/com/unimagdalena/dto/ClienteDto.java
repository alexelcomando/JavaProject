...
public class ClienteDto {
    ...
    private PeliculaDto idPeliculaCliente;
    ...
    public ClienteDto(int idCliente, String nombreCliente, String tipoDocumentoCliente, LocalDate fechaDeNacimientoCliente, Boolean sexoCliente, String esAccesoVipCliente, PeliculaDto idPeliculaCliente, String nombreImagenPublicoCliente, String nombreImagenPrivadoCliente) {
    ...
    public PeliculaDto getIdPeliculaCliente() {
        return idPeliculaCliente;
    }

    public void setIdPeliculaCliente(PeliculaDto idPeliculaCliente) {
        this.idPeliculaCliente = idPeliculaCliente;
    }
