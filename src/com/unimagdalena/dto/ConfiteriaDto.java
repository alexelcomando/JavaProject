...
public class ConfiteriaDto {
    ...
    public ConfiteriaDto() {
    }

    public ConfiteriaDto(int idConfiteria, String nombreProductoConfiteria, Double precioProductoConfiteria, String tipoProductoConfiteria, Boolean productoDisponibleConfiteria, LocalDate fechaCompraProducto, String metodoPagoProducto, String nombreImagenPublicoConfiteria, String nombreImagenPrivadoConfiteria) {
